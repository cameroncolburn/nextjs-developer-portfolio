    ...
    return (
        ...
        <div className="container flex flex-col items-center py-4 sm:py-8 mx-auto px-7 max-w-7xl sm:flex-row">
            ...
            <span className="inline-flex justify-center mt-4 space-x-5 sm:ml-auto sm:mt-0 sm:justify-start">
                <a href="https://github.com/cameroncolburn/" target="_blank" className="text-neutral-100 social-icon">
                ...
                <a href="https://www.linkedin.com/in/camcolburn" target="_blank" className="text-neutral-100 social-icon">
